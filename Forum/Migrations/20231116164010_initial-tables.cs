        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPosterId = table.Column<string>(type: "text", nullable: true),
                    CommunityPosterId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_UserPosterId",
                        column: x => x.UserPosterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Posts",
                column: "CommunityPosterId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_UserPosterId",
                table: "Posts",
                column: "UserPosterId");
        }
